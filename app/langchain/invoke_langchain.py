...
def invoke_langchain(prompt_langchain_template, input_variables):
    ...
    llm_model = input_variables.get('llm_model', "gpt-4o-mini") #------------as we have only one source openai so I am using gpt-4o-mini, we can use other models as well.
    input_temperature = input_variables.get("temperature", 1)
